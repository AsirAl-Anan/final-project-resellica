...
import userDataFetchController from "../controllers/userDataFetchController.jsx";
const userRouter = Router();

userRouter
  .route("/api/v1/register")
  .post(upload.none(), registrationController);
userRouter.route('/api/v1/get-user-data',verifyUserToken, userDataFetchController)
