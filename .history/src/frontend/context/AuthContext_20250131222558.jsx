    ...
    const signupWithGoogle = async () => {
      try {
        ...
        if (registerResponse.status === 201) {
          ...
          // Step 6: Set verification states
          setEmailVerificationSent(false);
          setEmailVerifying(false);
          setMessage('Google sign-up successful');
        } else {
          // If registration fails, delete the user from Firebase
          setError('Google sign-up failed');
          console.log("Deleting user from Firebase due to failed registration...");
          try {
            ...
            setError('Failed to delete user after registration failure');
          }
