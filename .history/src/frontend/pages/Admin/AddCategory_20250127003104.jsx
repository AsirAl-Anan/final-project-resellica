...
const AddCategory = () => {
  const [emoji, setEmoji] = useState(""); // Initialize as an empty string
  ...
  const handleEmojiClick = (event, emojiObject) => {
    setEmoji(emojiObject.emoji); // Update the emoji state with the selected emoji
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              placeholder="😀"
              value={emoji} // Controlled input: value is always bound to the emoji state
