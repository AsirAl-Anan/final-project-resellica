            ...
            <div className="p-4">
              ...
              <div className="mt-4 space-y-2 text-sm text-gray-600">
                ...
                <NavLink 
                  ...
                  className={'w-full block rounded-md py-2 text-center text-sm font-medium bg-purple-600 text-white hover:bg-purple-700'
                  }
                >
                   Add to Watchlist
                </NavLink>
                <NavLink   to={`/product/${product._id}`} className="w-full block rounded-md border border-purple-600 py-2 text-center text-sm font-medium text-purple-600 hover:bg-purple-50">
                  Book now
                </NavLink>
              </div>
              </div>
