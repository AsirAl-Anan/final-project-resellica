...
const navigationItems = [
  {
    ...
    items: [
      ...
      { icon: Users, text: 'Sellers', path: '/seller-panel/sellers' },
      { icon: Users, text: 'Users', path: '/seller-panel/users' },
      { icon: ShoppingBag, text: 'Add Product', path: '/seller-panel/products' },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Calendar, text: 'Calendar', path: '/seller-panel/calendar' },
