...
const ProductListing = ({
  ...
  const handleWatchlist = async (product) => {
    try {
      ...
      // You might want to update UI state based on the response
      // response.data.action will be either "added" or "removed"
          ...
          <div  key={product._id} className="w-full max-w-xs overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm hover:shadow-lg transition-shadow">
            ...
            <div className="p-4">
              ...
              <div className="mt-4 space-y-2">
               ...
               {product.isInWatchList ? "Add to Watchlist" : "Remove from Watchlist"}
                </button>
