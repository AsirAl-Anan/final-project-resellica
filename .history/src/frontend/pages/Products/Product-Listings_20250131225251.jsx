          ...
          <div key={product._id} className="w-full max-w-xs overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm hover:shadow-lg transition-shadow">
            ...
            <div className="p-4">
              ...
              <div className="mt-4 space-y-2">
                ...
                <NavLink to={`/product/${product._id}`} className="block w-full rounded-md border border-purple-600 py-2 text-center text-sm font-medium text-purple-600 hover:bg-purple-50">
                  Book now
                </NavLink>
              </div>
            </div>
