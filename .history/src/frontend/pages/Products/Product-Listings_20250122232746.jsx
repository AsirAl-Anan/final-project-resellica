      ...
      <div className="flex gap-8">
        ...
        <div className="w-64">
          ...
          <ul className="space-y-2">
            {categories.map((category) => (
              <li key={category} className="text-gray-900 hover:underline cursor-pointer">
                {category}
              </li>
            ))}
          </ul>
        ...
        <div className="flex-1">
          <div className="flex items-center gap-4 mb-4">
            ...
            <button className="text-gray-900">Auction</button>
            <button className="text-gray-900">Buy It Now</button>
          </div>

          <p className="text-gray-900 mb-4">819,138 Results</p>
          ...
          <div className="space-y-6">
            {products.map((product) => (
              <div key={product.id} className="flex gap-4 border-b pb-6">
                ...
                <div className="flex-1">
                  <h3 className="text-gray-900 hover:underline text-lg mb-1">{product.title}</h3>
                  ...
                  <div className="text-gray-900 mb-1">Was: ${product.wasPrice}</div>
                  <div className="text-gray-900 mb-1">{product.shipping}</div>
                  <div className="text-gray-900 mb-1">{product.soldCount}</div>
