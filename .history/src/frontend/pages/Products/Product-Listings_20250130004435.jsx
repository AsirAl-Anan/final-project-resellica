...
const ProductPage = () => {
  ...
  // Query for fetching user's country and available countries
  const { data: locationData } = useQuery({
    queryKey: ['countries'],
    queryFn: fetchCountriesAndUserLocation
  });

  // Set initial country when data is loaded
  useEffect(() => {
    if (locationData?.userCountry) {
      setSelectedCountry(locationData.userCountry);
    }
  ...
  const { data, isLoading } = useQuery({
    queryKey: ['products', currentPage, priceRange, sortBy, selectedCountry],
    queryFn: () => fetchProducts(currentPage, priceRange, sortBy, selectedCountry),
