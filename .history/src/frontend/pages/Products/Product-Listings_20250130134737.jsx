...
import ProductOverview from '../Admin/AdminComponents/Ui/ProductOverview.jsx';
          ...
          <div key={product._id} className="bg-white rounded-lg shadow hover:shadow-lg transition-shadow">
            <div className="p-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-600"> <NavLink className={"text-sky-500 hover:underline"}>{product.sellerAccount[0].username}</NavLink></p>
                <p className="text-gray-600">Location: {product.seller.country}</p>
                <p className="font-bold text-lg">{product.currency}{product.resalePrice}</p>
