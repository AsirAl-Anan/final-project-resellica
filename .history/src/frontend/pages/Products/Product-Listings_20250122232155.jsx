      ...
      <div className="flex gap-8">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-4 mb-4">
            ...
            <button className="text-blue-600">Auction</button>
            <button className="text-blue-600">Buy It Now</button>
          </div>
          ...
          <div className="space-y-6">
            {products.map((product) => (
              <div key={product.id} className="flex gap-4 border-b pb-6">
                ...
                <div className="flex-1">
                  <h3 className="text-blue-600 hover:underline text-lg mb-1">{product.title}</h3>
...
export default EbayElectronics;