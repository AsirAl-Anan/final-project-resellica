    ...
    <div className="flex-1">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {products.map((product) => (
          <div to={`/product/${product._id}`} key={product._id} className="w-full max-w-xs overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm hover:shadow-lg transition-shadow">
            ...
            <div className="p-4">
              ...
              <div className="mt-4 space-y-2">
                <button onClick={()=> handleWatchlist(product)} className="w-full rounded-md bg-purple-600 py-2 text-center text-sm font-medium text-white hover:bg-purple-700">
                  Add to Watchlist
                </button>
