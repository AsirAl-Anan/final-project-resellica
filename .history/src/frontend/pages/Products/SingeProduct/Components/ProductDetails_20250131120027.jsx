...
export default function ProductDetails({ product }) {
  ...
  const [localIsInWatchlist, setLocalIsInWatchlist] = useState(product.isInWatchlist);
  const [localWatchlistCount, setLocalWatchlistCount] = useState(product.watchlistCount);
  ...
  const handleWatchlist = async () => {
    try {
      ...
      setLocalWatchlistCount(prev => localIsInWatchlist ? prev - 1 : prev + 1);
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <div>{localWatchlistCount} users</div>
        </div>
      </div>
      ...
      <div className="space-y-3">
        ...
        >
          {localIsInWatchlist ? 'Remove from watchlist' : 'Add to watchlist'}
        </button>
      </div>
    </div>
  );
