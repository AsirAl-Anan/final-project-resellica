...
export default function BusinessRegisterPage() {
  ...
  const {user,error,message, emailVerificationSent, emailVerifying, dbUser,signupBussinessAccount, setError} = useContext(AuthContext);
 ...
 console.log("db user",dbUser)
  ...
  }, [user?.emailVerified, isNewSignup, mesdbUsersage, navigate,user,]);
