...
export default function BusinessRegisterPage() {
  ...
  // Flag to track if the seller signed up in this session
  ...
  useEffect(() => {
    ...
    if (seller?.emailVerified === true && isNewSignup) {
  ...
  }, [seller?.emailVerified, isNewSignup, message, navigate,user,seller]);
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header className="p-4 flex justify-between items-center border-b">
        ...
        <div className="text-sm">
          ...
          <NavLink to="/seller-login" className="text-blue-600 hover:text-blue-700 font-medium">
            Sign in
          </NavLink>
        </div>
      </header>
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
          <div className="max-w-md w-full space-y-8">
            <div className="text-center">
              <h1 className="text-2xl font-bold">Set up your account for selling on resellica</h1>
            </div>
