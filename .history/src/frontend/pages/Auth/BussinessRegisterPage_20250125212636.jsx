...
export default function BusinessRegisterPage() {
  ...
  const {user,error,message, emailVerificationSent} = useContext(AuthContext);
      ...
      <main className="flex-1 flex">
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
          <div className="max-w-md w-full space-y-8">
            ...
            {/* Account Type Toggle */}
            <div className="bg-gray-100 rounded-full p-1  py-2 px-4 rounded-full text-sm font-medium transition-colors bg-white shadow">
