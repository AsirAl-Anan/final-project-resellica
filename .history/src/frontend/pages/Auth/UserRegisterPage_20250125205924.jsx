      ...
      <main className="flex-1 flex">
        ...
        {emailVerificationSent && emailVerifying && (
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="">
    <button className="w-full hover:bg-gray-300 flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
