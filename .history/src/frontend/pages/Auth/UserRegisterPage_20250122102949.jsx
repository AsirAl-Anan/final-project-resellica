...
import validateForm from "../../frontend-utils/formvalidator"
export default function UserRegisterPage() {
  ...
  // };
  validateForm(formData.firstName,formData.lastName,formData.email,formData.password,formData.confirmPassword, setError)
