...
import { validateForm,handleInputChangeWrapper } from "../../frontend-utils/formutils"
export default function UserRegisterPage() {
  ...
  const handleInputChangeWrapperWrapper = (e) => {
    handleInputChangeWrapper(e, formData, setFormData);
  };
  useEffect(() => {
    if (error) {
      toast.error(error, {
            ...
            <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChangeWrapperWrapper}
