...
export default function BusinessRegisterPage() {
   const [countries, setCountries] = use
  const getCountries =()=> fetch('https://restcountries.com/v3.1/all').then(res=>res.json()).then(data=>{
  ...
  const { user, error, signupBussinessAccount, setError, emailVerificationSent, emailVerifying } =
