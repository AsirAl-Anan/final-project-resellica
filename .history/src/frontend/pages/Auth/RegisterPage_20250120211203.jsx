...
import { NavNavLinl } from "react-router-dom"
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header className="p-4 flex justify-between items-center border-b">
        ...
        <div className="text-sm">
          ...
          <NavLinl href="/login" className="text-blue-600 hover:text-blue-700 font-medium">
            Sign in
          </NavLinl>
        </div>
      </header>
          ...
          <div className="max-w-md w-full space-y-8">
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="text-sm text-gray-600">
                ...
                <NavLinl href="/terms" className="text-blue-600 hover:text-blue-700">
                  User Agreement
                </NavLinl>{" "}
                and acknowledge reading our{" "}
                <NavLinl href="/privacy" className="text-blue-600 hover:text-blue-700">
                  Privacy Notice
                </NavLinl>
              </div>
