...
import { validateBusinessForm,va } from "../../frontend-utils/formutils";
...
export default function BusinessRegisterPage() {
  ...
  const {
    user,
    error,
    signup, // Using the signup function from AuthContext
    setError,
  ...
  // Effect to handle successful email verification
  useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Call the signup function with business details
      ...
      if (emailVerificationSent && emailVerifying) {
        toast.info("Please verify your email to complete the registration.", {
          position: "top-right",
          autoClose: 5000,
          hideProgressBar: true,
          closeOnClick: false,
