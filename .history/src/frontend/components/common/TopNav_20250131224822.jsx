...
const TopNav = () => {
 ...
 console.log("dbUser",dbUser)
  ...
  dbUser?.role === "admin" ? (
    ...
    <NavLink onClick={'/account'} className="flex items-center gap-1 hover:underline">
    Account
...
{
  dbUser?.role === "seller" || dbUser?.role === "user" ? (
    <>
    <NavLink to="/business-register" className="hover:underline">
      sell
    </NavLink>
    <NavLink to={'/account'}  className="flex items-center gap-1 hover:underline">
    Account
