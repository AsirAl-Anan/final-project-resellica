    ...
    <div className="w-full bg-white border-b text-sm">
      <div className="max-w-[1440px] mx-auto px-6 py-1.5 flex justify-between items-center">
        <div className="flex items-center gap-4">
          {
            !dbUser && <div className="flex items-center gap-1">
            <span>Hi!</span>
          ...
          <div className="flex items-center gap-4">
          {
            true && <div className="flex items-center gap-1">
            <span>Hi!</span>
          
            <NavLink to={'/logout'} className="text-[#3665F3] hover:underline">logout</NavLink>
          </div>
          }
