    ...
    <div className="w-full bg-white border-b text-sm">
      <div className="max-w-[1440px] mx-auto px-6 py-1.5 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          {
            dbUser &&
          <div>Hello! <h1 className='text-base inline text-cyan-500'>{dbUser[0]?.username}</h1> </div>  
        ...
        <div className="flex items-center gap-6">
          {
            dbUser[0]?.role === "admin" &&
          <NavLink to={'/business-register'} className="hover:underline">Admin Panel</NavLink >
          }
