...
import AccountPage from './frontend/pages/UserAccount';
import Watchlist from './frontend/pages/WatchListPage';
import SearchResults from './frontend/pages/SearchPage';
import PaymentPage from './frontend/pages/PaymentPage';
import OrderHistoryPage from './frontend/pages/Order-historyPage';
