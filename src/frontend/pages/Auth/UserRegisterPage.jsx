...
import { validateForm,handleInputChange } from "../../frontend-utils/formutils"
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header className="p-4 flex justify-between items-center border-b">
        ...
        <div className="text-sm">
          ...
          <NavLink to="/sign-in" className="text-blue-600 hover:text-blue-700 font-medium">
            Sign in
          </NavLink>
        </div>
      </header>
      ...
      <main className="flex-1 flex">
        ...
        {emailVerificationSent && emailVerifying && (
            ...
            <div className="bg-gray-100 rounded-full p-1 flex">
              <NavLink
                to="/user-register"
                className={`flex-1 py-2 px-4 rounded-full text-sm font-medium transition-colors text-center bg-white shadow`}
              >
                Personal
              </NavLink>
            ...
            disabled={googleLoading || (emailVerificationSent && emailVerifying)}
            className="w-full flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed"
          >
